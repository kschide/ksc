    ...
    rpcConsole(0)
{
    ...
    setWindowTitle(tr("Kashmircoin") + " " + tr("Wallet"));
    qApp->setStyleSheet("QMainWindow { background-image:url(:images/main);height:1005px;width:539px; } #toolbar2 { background-image:url(:images/head);height:435;width:335px;border-top-left-style: outset; border-top-left-width:2px;border-top-left-radius:30px;border-color:rgb(181, 158, 142); }");
#ifndef Q_OS_MAC
    ...
    kashbitWindow = new KashbitWindow(this);
    ...
    mylabel->setPixmap(QPixmap(":icons/txbar"));
    mylabel->show();;
    vbox->addWidget(mylabel);
    vbox->addWidget(transactionView);
    vbox->setContentsMargins(0,66,22,10);
    ...
    spacer5->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
    QLabel *mylabel2 = new QLabel (this);
    mylabel2->setPixmap(QPixmap(":icons/toolsbar"));
    mylabel2->show();
    //kashgirl = new QLabel(":/movies/kashgirl", "png", this);
    //camelpurple = new QMovie(":/movies/camelpurple", "gif", this);
    labelg = new QLabel (this);
    labelg->setPixmap(QPixmap(":/movies/kashgirl"));
    labelg->show();
    QToolBar *toolbar8 = addToolBar(tr("Settings2"));
    toolbar8->addWidget(mylabel2);
    toolbar8->setFixedSize(657,36);
    QToolBar *toolbar3 = addToolBar(tr("Settings2"));
    toolbar3->addWidget(spacer);
    toolbar3->addWidget(labelg);
    ...
    toolbar5->setIconSize((QSize(134,96)));
    toolbar6->setIconSize((QSize(134,96)));
    settingsPage = new QWidget(this);
    QGridLayout *vbox2 = new QGridLayout();

    vbox2->addWidget(toolbar8, 0, 0);
    vbox2->addWidget(toolbar3, 1, 0);
    vbox2->addWidget(toolbar5, 1, 1);
    vbox2->addWidget(toolbar6, 1, 2);
    vbox2->setContentsMargins(0,66,140,0);
    settingsPage->setStyleSheet("QToolBar { border:none; } QToolBar QToolButton { border:none;height:75px; }");
    ...
    centralWidget->addWidget(kashbitWindow);
    ...
    QToolBar *toolbar2 = addToolBar(tr("Connection And Staking Status"));
    addToolBar(Qt::LeftToolBarArea,toolbar2);
    toolbar2->setOrientation(Qt::Vertical);
    toolbar2->setMovable( false );
    toolbar2->setObjectName("toolbar2");
    toolbar2->setFixedWidth(335);
    toolbar2->setFixedHeight(435);
    //toolbar2->setIconSize(QSize(54,54));
    ...
    toolbar2->setStyleSheet("#toolbar2 QToolButton { border:none;padding:0px;margin:0px;height:20px;width:20px;margin-top:218px;margin-left:5px; }");
...
void BitcoinGUI::createActions()
{
    ...
    kashbitAction = new QAction(QIcon(":/icons/kashbit"), tr("&KashBit"), this);
    kashbitAction->setToolTip(tr("KashBit"));
    kashbitAction->setCheckable(true);
    tabGroup->addAction(kashbitAction);
    ...
    optionsAction->setToolTip(tr("Modify configuration options for Kashmircoin"));
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Kashmircoin address"));
    ...
    connect(kashbitAction, SIGNAL(triggered()), this, SLOT(gotoKashbitPage()));
    ...
    aboutAction->setToolTip(tr("Show information about Kashmircoin"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setIconSize(QSize(50,27));
    QWidget* spacer2 = new QWidget();
    spacer2->setFixedSize(70,100);
    ...
    toolbar->addAction(kashbitAction);
    ...
    toolbar->setStyleSheet("#toolbar { border:none;height:100%;padding-top:0px;background: transparent; text-align: left; color: white;min-width:1000px;max-width:1000px;} QToolBar QToolButton:hover {background:rgb(28,29,33);} QToolBar QToolButton:checked {background:rgba(28,29,33,100);}  QToolBar QToolButton { font-weight:600;font-size:8px;font-family:'Century Gothic';padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:35px; width:70%; color: black; text-align: center; background:transparent;text-transform:uppercase; }");
    ...
    QWidget* spacer7 = new QWidget();
    spacer7->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
    spacer7->setFixedSize(5,5);
    toolbar7->addWidget(spacer7);
    spacer7->setObjectName("spacer7");
    toolbar7->addAction(quitAction);
    toolbar7->setStyleSheet("#toolbar7 { border:none; max-width:25px; } QToolBar QToolButton {border:0px; spacing:1px; max-width:10px; } QToolBar{ border:0px; spacing:1px; max-width:40 px; }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Kashmircoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::setWalletModel(WalletModel *walletModel)
{
    ...
    if(walletModel)
    {
        ...
        kashbitWindow->setModel(clientModel);
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Kashmircoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setPixmap(QIcon(icon).pixmap(185,22));
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Kashmircoin network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    if(secs < 90*60 && count >= nTotalBlocks)
    {
        ...
        labelBlocksIcon->setPixmap(QIcon(":/icons/synced").pixmap(185,23));
...
void BitcoinGUI::gotoOverviewPage()
{
    ...
    centralWidget->setMaximumWidth(675);
    centralWidget->setMaximumHeight(440);
...
void BitcoinGUI::gotoKashbitPage()
{
    kashbitAction->setChecked(true);
    centralWidget->setCurrentWidget(kashbitWindow);
    actionConvertIcon->setEnabled(true);
    actionConvertIcon->setVisible(true);
    disconnect(actionConvertIcon, SIGNAL(triggered()), 0, 0);
    connect(actionConvertIcon, SIGNAL(triggered()), this, SLOT(sConvert()));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Kashmircoin address or malformed URI parameters."));
    }
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unencrypted:
        ...
        labelg->hide();
        labelg->setMaximumSize(0,0);
        lockWalletAction->setVisible(false);
        encryptWalletAction->setEnabled(true);
        break;
    case WalletModel::Unlocked:
        labelEncryptionIcon->show();
        labelEncryptionIcon->setPixmap(QIcon(":/icons/lock_open").pixmap(185,25));
        labelEncryptionIcon->setToolTip(tr("Wallet is <b>encrypted</b> and currently <b>unlocked</b>"));
        encryptWalletAction->setChecked(true);
        changePassphraseAction->setEnabled(true);
        unlockWalletAction->setVisible(false);
        labelg->show();
        labelg->setMaximumSize(200,200);
    ...
    case WalletModel::Locked:
        labelEncryptionIcon->show();
        labelEncryptionIcon->setPixmap(QIcon(":/icons/lock_closed").pixmap(185,25));
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    if (nLastCoinStakeSearchInterval && nWeight)
    {
        ...
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_on").pixmap(185,23));
        labelStakingIcon->setToolTip(tr("Staking.<br>Your weight is %1<br>Network weight is %2<br>Expected time to earn reward is %3").arg(nWeight).arg(nNetworkWeight).arg(text));
    }
    else
    {
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_off").pixmap(185,23));
