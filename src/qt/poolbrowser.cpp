...
const QString kBaseUrl3 = "http://bittrex.com/api/v1/public/getorderbook?market=BTC-KSC&type=both&depth=50";
const QString kBaseUrl4 = "http://poloniex.com/public?command=returnTicker";
const QString kBaseUrl5 = "http://www.poloniex.com/public?command=returnOrderBook&currencyPair=BTC_KSC";
const QString kBaseUrl6 = "http://bittrex.com/api/v1/public/getmarkethistory?market=BTC-KSC&count=100";
...
//    QStringList data2 = data.split("\"BTC-KSC\":{\"last\":\"");
